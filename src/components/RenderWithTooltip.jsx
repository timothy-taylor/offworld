const baseStyle =
    "absolute hidden group-hover:flex -top-2 -right-3 translate-x-full w-32 px-2 py-1 bg-gray-700" +
    " rounded-lg text-center text-white text-sm",
  beforeStyle =
    "before:content-[''] before:absolute before:top-1/2  before:right-[100%] before:-translate-y-1/2" +
